...
export function ProtocolVisual() {
  return (
    <div className="relative aspect-square w-full max-w-[640px]">
      ...
      <div className="absolute inset-[18%] rounded-full border border-hairline" style={{ animation: "pulse-ring 3s ease-in-out infinite", animationDelay: "1s" }} />
      ...
      <svg viewBox="0 0 600 600" className="relative h-full w-full">
        ...
        <motion.circle
          cx="300" cy="300" r="92"
          fill="none" stroke="oklch(0.78 0.16 160 / 35%)" strokeWidth="1"
          strokeDasharray="3 6"
          animate={{ rotate: 360 }}
        ...
        <motion.circle
          cx="300" cy="300" r="64"
          fill="none" stroke="oklch(0.82 0.12 200 / 30%)" strokeWidth="1"
          strokeDasharray="2 4"
          animate={{ rotate: -360 }}
        ...
        <g filter="url(#soft-glow)">
          <polygon
            ...
            strokeWidth="1"
          />
          <text x="300" y="305" textAnchor="middle" fontSize="11" fontFamily="JetBrains Mono" fill="oklch(0.78 0.16 160)" letterSpacing="2">ZK</text>
        </g>

        {/* Flow paths */}
        <g fill="none" strokeWidth="1.2">
          <path d="M 80 140 Q 200 200 257 290" stroke="url(#line-emerald)" strokeDasharray="4 4" className="animate-dash" />
          <path d="M 520 140 Q 400 200 343 290" stroke="url(#line-cyan)" strokeDasharray="4 4" className="animate-dash" style={{ animationDelay: "1.5s" }} />
          <path d="M 80 460 Q 200 420 257 320" stroke="url(#line-emerald)" strokeDasharray="4 4" className="animate-dash" style={{ animationDelay: "2.5s" }} />
          <path d="M 520 460 Q 400 420 343 320" stroke="url(#line-cyan)" strokeDasharray="4 4" className="animate-dash" style={{ animationDelay: "3.5s" }} />
        </g>
        ...
        {[
          ...
          <g key={i}>
            <motion.circle
              ...
              fill="none" stroke={n.c} strokeOpacity="0.4"
        ...
        <circle cx="300" cy="300" r="240" fill="none" stroke="oklch(1 0 0 / 6%)" strokeWidth="1" strokeDasharray="1 8" />
      </svg>
...
function FloatingTag({
  ...
  const dot =
    accent === "emerald" ? "bg-emerald" : accent === "cyan" ? "bg-cyan" : "bg-violet";
  return (
    <motion.div
