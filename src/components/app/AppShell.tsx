...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
        <path
          d="M2 11L7.5 2l5.5 9H2z"
          stroke="currentColor"
          strokeWidth="1.35"
          strokeLinejoin="round"
        />
        <path
          d="M4.5 11V8.5M10.5 11V8.5M7.5 11V6"
          stroke="currentColor"
          strokeWidth="1.35"
          strokeLinecap="round"
        />
  ...
  },
  {
    ...
    icon: (
      <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
        ...
        />
        <path
          d="M10.5 9c1.38 0 2.5 1.57 2.5 3.5"
          stroke="currentColor"
          strokeWidth="1.35"
          strokeLinecap="round"
        />
  ...
  },
  {
    ...
    icon: (
      <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
        <path
          d="M1 7.5h2l2-4 2 8 2-6 2 4 1-2h2"
          stroke="currentColor"
          strokeWidth="1.35"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    ...
    icon: (
      <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
        ...
        <path
          d="M7.5 4v3M7.5 7H3m0 0v1M7.5 7h4.5m0 0v1"
          stroke="currentColor"
          strokeWidth="1.35"
          strokeLinecap="round"
        />
  ...
  },
  {
    ...
    icon: (
      <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
        ...
        <path
          d="M7.5 1.5v1M7.5 12.5v1M1.5 7.5h1M12.5 7.5h1M3.1 3.1l.7.7M11.2 11.2l.7.7M3.1 11.9l.7-.7M11.2 3.8l.7-.7"
          stroke="currentColor"
          strokeWidth="1.35"
          strokeLinecap="round"
        />
...
function ZKGentMark() {
  return <img src="/logo.png" alt="ZKGent" className="h-8 w-8 shrink-0 rounded-md" />;
}
...
function Sidebar({ onClose }: { onClose?: () => void }) {
  ...
  const NavLink = ({ item }: { item: NavItem }) => {
    ...
    return (
      ...
      >
        <span
          className={`transition-colors ${isActive ? "text-emerald" : "text-muted-foreground/60 group-hover:text-foreground"}`}
        >
          {item.icon}
        </span>
        {item.label}
    ...
    <div className="flex h-full flex-col">
      <div className="flex items-center gap-2.5 px-4 py-4 border-b border-hairline">
        ...
        <div>
          ...
          <p className="font-mono text-[9px] tracking-wider text-muted-foreground/50 leading-none mt-0.5">
        ...
        <header className="flex h-12 shrink-0 items-center gap-3 border-b border-hairline bg-surface/20 px-4">
          ...
          {currentItem && (
            <div className="hidden lg:flex items-center gap-2">
              <span className="text-muted-foreground/40">{currentItem.icon}</span>
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            {network && (
              <div className="hidden sm:flex items-center gap-1.5">
                <div
                  className={`h-1.5 w-1.5 rounded-full ${network === "mainnet-beta" ? "bg-emerald" : "bg-yellow-400/70"}`}
                />
                <span
                  className={`font-mono text-[10px] uppercase tracking-widest ${network === "mainnet-beta" ? "text-emerald/70" : "text-yellow-400/60"}`}
                >
