...
const PHASES: Phase[] = [
  {
    ...
    bullets: [
      ...
      "Wallet-authenticated settlement flow with signed challenge-response sessions",
      "Settlements are prepared for user wallet signing, then posted on Solana devnet via SPL Memo anchoring",
