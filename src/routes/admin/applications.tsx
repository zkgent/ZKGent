      ...
      >
        ...
        <div className="space-y-3">
          <input
            ...
            className={cn(
              "w-full rounded-lg border bg-surface px-4 py-3 text-[14px] text-foreground placeholder:text-muted-foreground/40 outline-none transition-all",
              error
                ? "border-destructive/60 focus:border-destructive"
                : "border-hairline focus:border-emerald/50 focus:ring-1 focus:ring-emerald/20",
            )}
          />
    ...
    >
      ...
      <div className="p-5 space-y-6">
        ...
        <div>
          ...
          <p className="text-[12px] leading-relaxed text-foreground rounded-lg border border-hairline bg-background p-3">
            {app.whyConfidential}
          </p>
        </div>
            ...
            {STATUS_OPTIONS.slice(1).map((opt) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex items-center gap-2 rounded-lg border px-3 py-2.5 text-[11px] font-medium transition-all",
                    status === opt.value
                      ? "border-emerald/40 bg-emerald/8 text-foreground"
                      : "border-hairline bg-background text-muted-foreground hover:border-foreground/20",
                  )}
                >
    ...
    <div className="min-h-screen bg-background text-foreground relative">
      ...
      <div className="mx-auto max-w-6xl px-6 py-8">
        <div className="mb-6 flex flex-wrap items-center gap-3">
          ...
          <button
            onClick={() => adminKey && fetchApps(adminKey)}
            ...
            {meta.byStatus.map(({ status, count }) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex items-center gap-2 rounded-full border px-3 py-1 font-mono text-[10px] uppercase tracking-wider transition",
                    statusFilter === status
          ...
          <div className="overflow-hidden rounded-xl border border-hairline">
            <table className="w-full">
              <thead className="border-b border-hairline bg-surface-elevated">
                <tr>
                  {["Name", "Company", "Use Case", "Volume", "Status", "Wallet", "Applied"].map(
                    (h) => (
                      <th
                        key={h}
                        className="px-4 py-3 text-left font-mono text-[9px] uppercase tracking-widest text-muted-foreground/60"
                      >
                        {h}
                      </th>
                    ),
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-[12px] text-muted-foreground">
                        {USE_CASE_LABELS[app.useCase] || app.useCase}
                      </td>
                      <td className="px-4 py-3 text-[12px] text-muted-foreground">
                        {app.monthlyVolume}
                      </td>
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1.5">
                          ...
                          <span
                            className={`font-mono text-[10px] uppercase tracking-wider ${s.text}`}
                          >
                            {s.label}
                          </span>
                        </div>
